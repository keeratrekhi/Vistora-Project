...
import { CREATE_EVENT_ROUTE, DASHBOARD_ROUTE, ADMIN_EVENTS_ROUTE, PORTFOLIO_INFO_ROUTE, PROFILE_ROUTE, PLANS_ROUTE } from '../constants/RouteContant'

const Sidebar: React.FC = () => {
    return (
        <>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="fixed top-16 left-0 z-40 flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white-400 dark:hover:bg-white-700 dark:focus:ring-white-600">
            ...
            <aside id="default-sidebar" className="fixed top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-pink-100 via-purple-100 to-blue-100 dark:bg-[#2C3E50]">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to={DASHBOARD_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                        ...
                        <li>
                            <Link to={ADMIN_EVENTS_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                        ...
                        <li>
                            <Link to={CREATE_EVENT_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                        ...
                        <li>
                            <Link to={PORTFOLIO_INFO_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                        ...
                        {/* <li>
                            <Link to={PROFILE_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                                <svg className="w-5 h-5 text-white-500 transition duration-75 dark:text-white-100 group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
                                    <path d="M512 80c8.8 0 16 7.2 16 16l0 320c0 8.8-7.2 16-16 16L64 432c-8.8 0-16-7.2-16-16L48 96c0-8.8 7.2-16 16-16l448 0zM64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l448 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zM208 256a64 64 0 1 0 0-128 64 64 0 1 0 0 128zm-32 32c-44.2 0-80 35.8-80 80c0 8.8 7.2 16 16 16l192 0c8.8 0 16-7.2 16-16c0-44.2-35.8-80-80-80l-64 0zM376 144c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0z"/>
                                </svg>
                        ...
                        <li>
                            <Link to={PLANS_ROUTE} className="flex items-center p-2 text-slate-700 rounded-lg dark:text-white hover:bg-white-100 dark:hover:bg-white-100 group hover:text-black">
                                <svg className="w-5 h-5 text-white-500 transition duration-75 dark:text-white-100 group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
                                    <path d="M512 80c8.8 0 16 7.2 16 16l0 320c0 8.8-7.2 16-16 16L64 432c-8.8 0-16-7.2-16-16L48 96c0-8.8 7.2-16 16-16l448 0zM64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l448 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zM208 256a64 64 0 1 0 0-128 64 64 0 1 0 0 128zm-32 32c-44.2 0-80 35.8-80 80c0 8.8 7.2 16 16 16l192 0c8.8 0 16-7.2 16-16c0-44.2-35.8-80-80-80l-64 0zM376 144c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0z"/>
                                </svg>
                                <span className="flex-1 ms-3 whitespace-nowrap">My Plans</span>
                            </Link>
                        </li> */}
                    </ul>
                </div>
